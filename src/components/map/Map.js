...
class Map extends Component {
  componentDidMount() {
    ...
    map.setZoom(18);
    //将项目草图数据导入至地图
    let jzd =maptalks.Layer.fromJSON(JSON.parse(projectData.ProjectItem.L.jzdJSONData));
    let sz =maptalks.Layer.fromJSON(JSON.parse(projectData.ProjectItem.L.szJSONData));
